//
//  7 21 Domain w Validation Functions.cpp
//  WGU Tester
//
//  Created by Luis Vegerano on 11/30/20.
//
...
bool HasValidSecondLevel(string secondLevel) {
   ...
   if ((secondLevelLength >= 1) && (secondLevelLength <= MAX_SECONDLEVEL_LENGTH)) {
      if ((secondLevel[0] == DASH) || (secondLevel[secondLevelLength - 1] == DASH)) {
